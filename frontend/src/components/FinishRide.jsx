...
// FinishRide is a component that displays the finish ride panel
const FinishRide = (props) => {
  const navigate = useNavigate();

  // endRide is a function that sends a request to the server to end the ride
  async function endRide() {
    // Send a POST request to the server to end the ride
    ...
    // If the response status is 200, navigate to the captain home page
